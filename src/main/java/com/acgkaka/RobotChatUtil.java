...
public class RobotChatUtil {
     ...
     * 存储APIkey
     */
    private static final String API_KEY = "dc445a15ce4640bfbe4395dce80b86ca";
    /**
     * 存储接口请求地址
     */
    ...
    private String getHTML(String url) {
        ...
        BufferedReader builderedReader = null;
        try {
            // 创建URL对象
            URL u = new URL(url);
            // 打开连接
            ...
            builderedReader = new BufferedReader(new InputStreamReader(connection.getInputStream()));
            String line;
            // 循环每次加入一行HTML内容 直到最后一行
            while ((line = builderedReader.readLine()) != null) {
                builder.append(line);
            }
        } catch (IOException e) {
            e.printStackTrace();
